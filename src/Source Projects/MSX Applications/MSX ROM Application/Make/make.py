            ...
            if len(tokens) > 0:
                ...
                if not key[0] == ';':
                    ...
                    if key == "MDO_APPLICATION_PROJECT_PATH":
                        ...
                        mim_s = mim_s + '{}/mdostructures.s'.format(VAR['MDO_APP_MDO_PATH'])
                    
                    elif key == 'MDO_PARENT_PROJECT_PATH':
                        setVar ('MDO_PARENT_PROJECT_PATH', value)
                        setVar ('MDO_PARENT_AFTERHEAP', '{}/{}/objs/PARENT_AFTERHEAP'.format(value, VAR['PROFILE']))
                        setVar ('MDO_PARENT_INTERFACE', '{}/{}/objs/parentinterface'.format(value, VAR['PROFILE']))
