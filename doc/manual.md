...
1. [Understanding the templates' files](#understanding-the-templates-files)
...
1. Build your project:
	...
	** with **“Debug”** or **“Release”** (case sensitive)):
	...
	Build:			python .\Make\make.py <PROFILE>
		Rebuild All: 		python .\Make\make.py <PROFILE>
			clean all
			Clean:			python .\Make\make.py <PROFILE>
				clean
				...
				Build:			python ./Make/make.py <PROFILE>
					Rebuild All: 		python ./Make/make.py <PROFILE>
						...
						Clean:			python ./Make/make.py <PROFILE>
							...
							prompt/terminal/shell and type **sdcc \<enter\>
								** and **sdasz80 \<enter\>
									** and be sure the programs are executed).
																			...
																			**Browse for disk folder (DirAsDisk)** on the drop down menu:
																			...
																			1. In MSX-BASIC, type the command **FILES \<ENTER\>
																				** to confirm that your program was added to the disk image:
																				...
																				1. Now… the time of truth! The moment we all have been waiting for… Type **BLOAD “\<FLOPPY DRIVE\>
																					:MSXAPP.BIN”, R
																					\<ENTER\>
																						** and you should see you program blissfully running:
																						...
																						**NOTE:** the messages are shown for just a brief moment because the example program just shows the messages and
																						...
																						test this feature after the boot, typing **CALL CMD1 ("Message") \<ENTER\>
																							** and **CALL RUNCART \<ENTER\>
																								**:
																								...
																								test this feature after the boot, typing **CALL CMD1 ("Message") \<ENTER\>
																									** and **CALL RUNCART \<ENTER\>
																										...
																										**System | Reset** menu option:
																										...
																										1. When MSX-DOS boot completes, issue the "**DIR \<ENTER\>
																											**" command and confirm that your program is available to be
																											executed:
																											...
																											1. Execute your program by typing "**MSXAPP \<ENTER\>
																												**":
																												...
																												experiment that too. Type "**MSXAPP \<PARAMETERS\>
																													\<ENTER\>
																														**":
																																...
																																experiment that too. Type "**MSXAPP \<PARAMETERS\>
																																	\<ENTER\>
																																		...
																																		**System | Reset** menu option:
																																		...
																																		1. When MSX-DOS boot completes, issue the "**DIR \<ENTER\>
																																			**" command and confirm that your files are available to be
																																			executed:

																																			![WebMSX MDO Dir](WebMSX-MDO-5.png "WebMSX DOS DIR")
																																			1. Optionally enter 80-column mode by typing "**MODE 80 \<ENTER\>
																																				**" (recommended) and execute your program by typing "**MSXAPP \<ENTER\>
																																					**":
																																					...
																																					experiment that too. Type "**MSXAPP \<PARAMETERS\>
																																						\<ENTER\>
																																							...
																																							**Drive A | Save Disk Image** menu option and store the file somewhere in your computer.
																																							...
																																							![OpenMSX DOS Start Emulation](OpenMSX-DOS-5.png "OpenMSX Start")
																																							1. When MSX-DOS boot completes, issue the "**DIR \<ENTER\>
																																								**" command and confirm that your program, along with the
